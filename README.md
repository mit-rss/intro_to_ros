...
3. Finally, when you have completed all problems, run ``./run_tests`` and upload your ``log.npz`` file to [Gradescope](https://gradescope.com/) under lab1c_exercises_ros.
